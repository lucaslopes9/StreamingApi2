						...
						<div class="col-md-3">
                            ...
                            <div class="pointer widget widget-default widget-item-icon" onclick="location.href='index.php?p=usuario&s=1';">
                                <div class="widget-item-center">
                                    <span</span>
					<img style="display: block; margin-left: auto; margin-right: auto;" src="img/img/ativo.gif" alt="" width="120" height="80">
                                </div>                             
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="pointer widget widget-default widget-item-icon" onclick="location.href='index.php?p=usuario&s=2';">
                                <div class="widget-item-center">
                                    <span</span>
					<img style="display: block; margin-left: auto; margin-right: auto;" src="img/img/esgotados.gif" alt="" width="120" height="80">
                                </div>                             
                                <div class="widget-data">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="pointer widget widget-default widget-item-icon" onclick="location.href='index.php?p=usuario&s=3';">
                                <div class="widget-item-center">
                                    <span</span>
					<img style="display: block; margin-left: auto; margin-right: auto;" src="img/img/bloqueios.gif" alt="" width="100" height="80">
                                </div>                             
                                <div class="widget-data">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="pointer widget widget-default widget-item-icon" onclick="location.href='index.php?p=teste&s=1';">
                                <div class="widget-item-center">
                                    <span</span>
					<img style="display: block; margin-left: auto; margin-right: auto;" src="img/img/testes.gif" alt="" width="120" height="80">
                                </div>                             
                                <div class="widget-data">
