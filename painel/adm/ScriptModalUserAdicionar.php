                    ...
                    <div class=\"modal-body form-horizontal form-group-separated\">     
						...
						<div class=\"form-group\">
                        	<label class=\"col-md-3 control-label\">".$_TRA['conexao']."</label>
                            	<div class=\"col-md-9\">
                                	<input type=\"text\" readonly=\"readonly\" name=\"EditarConexao\" id=\"EditarConexao\" class=\"form-control\" value=\"1\"/>
                                </div>
                        </div>";
						...
						echo "<div class=\"form-group\">
                            ...
                            <div class=\"col-md-9\">
								<div class=\"input-group date\">
                                	<input pattern=\"[A-Za-z]\" onkeypress=\"sem_acento(event)\" onkeydown =\"onKeyDown()\" type=\"text\" id=\"dp-3\" name=\"EditarPremium\" class=\"form-control\" />
						...
						<div class=\"form-group\">
                            ...
                            <div class=\"col-md-9\">
                                <input pattern=\"[A-Za-z]\" onkeypress=\"sem_acento(event)\" onkeydown =\"onKeyDown()\" id=\"ValorCobrado\" name=\"ValorCobrado\" type=\"text\" class=\"form-control\">
                            </div>
                        </div>
...
$(function(){  
 $("button.SalvarAdicionar").click(function() { 
		...
		$.post('EnviarAdicionarUser.php', Data, function(resposta) {
				$("#StatusModal").html('');
